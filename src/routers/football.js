...
async function getLeague() {
    try {
        ...
        log.createLog('Football Bot','','getLeague Error',error.data.message);
    }
}
...
async function setLeagueData(legueUrl,leagueName) {
    await axios.post('https://serve-dailyathon.ayberkcakar.xyz/league-standings', {
        ...
        .then(function (response) {
            log.createLog('Football Bot',legueUrl,leagueName+ ' information added successfully.',response.data.message);
        })
        .catch(function (error) {
            log.createLog('Football Bot',legueUrl,leagueName+ ' information added failed.',error.data.message);
        });
}
...
async function updateLeagueData(legueUrl,leagueName) {
    ...
    .then(function (response) {
        log.createLog('Football Bot',legueUrl,leagueName+ ' League information updated successfully.',response.data.message);
    })
    .catch(function (error) {
        log.createLog('Football Bot',legueUrl,leagueName+ ' League information updated failed.',error.data.message);
    });
}
